...
NK_API void                 nk_sdl_save_state(struct nk_sdl *dst);
NK_API void                 nk_sdl_restore_state(struct nk_sdl *src);
...
NK_API void
nk_sdl_save_state(struct nk_sdl *dst)
    { memcpy(dst, &sdl, sizeof(struct nk_sdl)); }

NK_API void
nk_sdl_restore_state(struct nk_sdl *src)
    { memcpy(&sdl, src, sizeof(struct nk_sdl)); }
